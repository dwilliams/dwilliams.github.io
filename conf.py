...
BLOG_TITLE = "port8080.net"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.port8080.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.port8080.net/"
BLOG_EMAIL = "dwilliams@port8080.net"
BLOG_DESCRIPTION = "A mishmash of thing from the days of my life."  # (translatable)
